...
namespace Nedeljni1_Andreja_Kolesar.Service
{
    ...
    public partial class dbFirmEntities : DbContext
    {
        public dbFirmEntities()
            : base("name=dbFirmEntities")
        {
        }
        ...
        public virtual DbSet<tblEditRequest> tblEditRequests { get; set; }
        public virtual DbSet<tblEmployee> tblEmployees { get; set; }
        public virtual DbSet<tblGender> tblGenders { get; set; }
        public virtual DbSet<tblManager> tblManagers { get; set; }
        public virtual DbSet<tblMarriageStatu> tblMarriageStatus { get; set; }
